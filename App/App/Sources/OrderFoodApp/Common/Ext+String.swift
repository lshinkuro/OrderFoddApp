...
extension NSMutableAttributedString {
    func addColoredText(color: UIColor, forText textToColor: String) {
        let range = (self.string as NSString).range(of: textToColor)
...
extension String {
    ...
    func coloredText(color: UIColor, forText textToColor: String) -> NSAttributedString {
        let attributedString = NSMutableAttributedString(string: self)
        
        // Mencari range dari teks yang ingin diberi warna
        let range = (self as NSString).range(of: textToColor)
        
        // Jika teks ditemukan, tambahkan warna
        if range.location != NSNotFound {
...
extension String {
    ...
    func prefixWords(_ pref: Int) -> String {
        let words = self.split(separator: " ")
        let firstFourWords = words.prefix(pref).joined(separator: " ")
